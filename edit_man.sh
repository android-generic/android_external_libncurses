...
(*.[0-9]*)
	...
	if test ! -f /media/work/external_placeholder/ncurses/man_alias.sed ; then
cat >>/media/work/external_placeholder/ncurses/man_alias.sed <<-CF_EOF2
		s,@DATADIR@,$datadir,g
...
s,@TSET@,tset,g
CF_EOF2
		echo "...made /media/work/external_placeholder/ncurses/man_alias.sed"
	fi
	...
	aliases=`sed -f $top_srcdir/man/manlinks.sed $inalias |sed -f /media/work/external_placeholder/ncurses/man_alias.sed | sort -u; test $inalias = $nCurses && echo curses`
	cf_target=`grep "^$cf_source" /media/work/external_placeholder/ncurses/man/man_db.renames | mawk '{print $2}'`
	...
	sed	-f /media/work/external_placeholder/ncurses/man_alias.sed \
		< $i | sed -f /media/work/external_placeholder/ncurses/edit_man.sed >$TMP
